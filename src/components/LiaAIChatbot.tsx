  ...
  return (
    <>
      ...
      <motion.button
        ...
        className={cn(
          "fixed bottom-6 right-6 lg:bottom-8 lg:right-8 z-[100] flex items-center gap-2 px-6 py-4 bg-primary text-white rounded-pill shadow-2xl shadow-primary/30 group transition-all",
